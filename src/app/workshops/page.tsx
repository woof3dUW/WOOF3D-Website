            ...
            <main className="MainContent">
                ...
                <div style={{width:"100%", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column"}}>
                    <table>
                        ...
                        {list.map((workshop, idx) => (
                            <tr className="Text" key={idx}>
                                <td className="Data">{workshop.date}</td>
                                <td className="Data">{workshop.name} {workshop.link === "" ? "" : <a href={workshop.link} className="Link" target="_blank" rel="noreferrer noopener">(slides)</a>}</td>
                            </tr>
                        ))}
                        </tbody>
                    </table>
