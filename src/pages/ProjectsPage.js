            ...
            <main className="MainContent">                
                ...
                <div className="Row">
                    <div className="RowSection">
                        ...
                        }><div><img className="Portrait" src={iss} alt="ISS-Mimic"/>ISS-Mimic</div></Link>
                    </div>
                    <div className="RowSection">
                        <Link className="Name" to="/projects/project" state={
                            {
                        ...
                        }><div><img className="Portrait" src={rcvehicle} alt="RC Vehicle"/>RC Vehicle</div></Link>
                    </div>
                </div>
                ...
                <div className="Row">
                    <div className="RowSection">
                        ...
                        }><div><img className="Portrait" src={casting} alt="Casting"/>Casting</div></Link>
                    </div>
                    <div className="RowSection">
                        <Link className="Name" to="/projects/project" state={
                            {
                        ...
                        }><div><img className="Portrait" src={droneteamone} alt="Drone Teams"/>Drone Teams</div></Link>
                    </div>
                </div>
                ...
                <div className="Row">
                    <div className="RowSection">
                        <Link className="Name" to="/projects/project" state={
                            {
                                ...
                                text: [
                                    `This project involves important scientific research and working with a research group to help 3D print two 
                                    newly discovered species of ground sloths from the Hoyo Negro project in Mexico, in hopes of comparing them to other known sloths. 
                        ...
                        }><div><img className="Portrait" src={fossil} alt="3D Printed Fossils"/>3D Printed Fossils</div></Link>
                    </div>
                    <div className="RowSection">
                        <Link className="Name" to="/projects/project" state={
                            {
                        ...
                        }><div><img className="Portrait" src={mediumblue} alt="Medium Blue"/>Medium Blue</div></Link>
                    </div>
                </div>
                ...
                <div className="Row">
                    <div className="RowSection">
                        ...
                        }><div><img className="Portrait" src={iro} alt="IRO-3D"/>IRO-3D</div></Link>
                    </div>
                    <div className="RowSection">
                        <Link className="Name" to="/projects/project" state={
                            {
                                ...
                                text: [
                                    `Goal: Using Big Blue to print large-scale turbines that “are otherwise un-machinable.” 
                                    Due to some difficulties, this project is more about updating Big Blue, our in-house large-scale 3D printer with a build space of approximately 1 m by 1 m.`,
                                    ...
                                    Gian, the team lead of the project, has expressed interest in a new project for the next year to create Big Blue 2.0, 
                                    using what he and the team learned this year to update the printer for future WOOF members. `
                                ]
                            }
                        }><div><img className="Portrait" src={turbine} alt="Turbine Printing"/>Turbine Printing</div></Link>
                    </div>
                </div>
                ...
                <div className="Row">
                    <div className="RowSection">
                        ...
                        }><div><img className="Portrait" src={voxel} alt="Voxel Printing"/>Voxel Printing</div></Link>
                    </div>
                    <div className="RowSection">
                        <Link className="Name" to="/projects/project" state={
                            {
                        ...
                        }><div><img className="Portrait" src={kidney} alt="Kidney Modeling"/>Kidney Modeling</div></Link>
                    </div>
                </div>
                ...
                <div className="Row">
                    <div className="RowSection">
                        ...
                        }><div><img className="Portrait" src={ppp} alt="Precious Plastics"/>Precious Plastics</div></Link>
                    </div>
                    <div className="RowSection">
                        <Link className="Name" to="/projects/project" state={
                            {
                        ...
                        }><div><img className="Portrait" src={printing} alt="Advanced Printing"/>Advanced Printing</div></Link>
                    </div>
                </div>
                ...
                <div className="Row">
                    <div className="RowSection">
                        ...
                        }><div><img className="Portrait" src={photogrammetry} alt="Photogrammetry"/>Photogrammetry</div></Link>
                    </div>
                    <div className="RowSection">
                        <Link className="Name" to="/projects/project" state={
                            {
